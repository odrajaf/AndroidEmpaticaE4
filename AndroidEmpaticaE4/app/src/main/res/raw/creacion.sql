...
CREATE TABLE IF NOT EXISTS logeoActual (
idLogueado INTEGER PRIMARY KEY AUTOINCREMENT,
emailLogueado text,
temporal INTEGER,
FOREIGN KEY (idLogueado) REFERENCES pacientes (id)
);
...
id INTEGER PRIMARY KEY AUTOINCREMENT,
valorPulsaciones REAL NOT NULL,
fecha TIMESTAMP NOT NULL,
idSesion INTEGER,
FOREIGN KEY (idSesion) REFERENCES sesiones (id)
ON DELETE CASCADE ON UPDATE CASCADE
